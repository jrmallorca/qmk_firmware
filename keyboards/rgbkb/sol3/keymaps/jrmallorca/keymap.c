 ...
 */
    ...
    [GAME_KK_RPG] = LAYOUT(
        ...
        KC_ESC , KC_A   , KC_X   , KC_C   , KC_V   , KC_B   , _______,                   _______, KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SCLN, KC_ENT ,
        _______, KC_Z   , _______, _______, _______, KC_LSFT , KC_LCTL, KC_TAB , LA_GNUM, KC_LALT, KC_SPC , _______, _______, _______, KC_SLSH, _______,
